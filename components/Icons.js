// Composant d'icônes SVG réutilisables
...
export const DeleteIcon = ({ size = 20, className = '' }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
...
export const GalleryIcon = ({ size = 20, className = '' }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
...
export const CreateIcon = ({ size = 20, className = '' }) => (
  <svg 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
